...
|---|---|
| 文档版本 | V3.0 MVP 完整版 |
| 文档状态 | 已确认需求、流程图、状态机、数据模型和开发边界合并稿 |
| 编制日期 | 2026-07-14 |
...
本文档合并初版设计和后续逐模块确认结果，是 MVP 的当前正式需求与技术基线。若本文档与初版 V1.0 冲突，以本文档为准。
...
- 标准响应、错误处理、请求 ID、日志、审计和配置框架。
- React、Vite、shadcn/ui、OpenAPI 类型生成。
